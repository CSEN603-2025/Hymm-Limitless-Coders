...
//         <button className="btn-primary1" onClick={() => navigate('/workshop/live')}>
//           Join Live Workshop
//         </button>
//       </div>
...
//         <button className="btn-outline1" onClick={() => navigate('/workshop/upcoming')}>
...
//         <button className="btn-outline1" onClick={() => navigate('/workshop/recorded')}>
//           View Recordings
//         </button>
//       </div>
    ...
    <div className="dashboard-container">
      ...
      {showNotification && (
        <div className="notification">
          🔔 Upcoming workshop is starting soon. Be ready to join!
        </div>
      )}
