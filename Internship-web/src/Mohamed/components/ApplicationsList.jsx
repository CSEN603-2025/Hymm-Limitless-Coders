...
const simulatedStatuses = ['pending', 'finalized', 'accepted', 'rejected'];
...
const ApplicationsList = () => {
  ...
  useEffect(() => {
    ...
    // Manually set status on each application to simulate different states
    storedApps = storedApps.map((app, index) => ({
      ...app,
      status: simulatedStatuses[index % simulatedStatuses.length],
    }));
